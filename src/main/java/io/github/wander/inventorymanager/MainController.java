...
public class MainController {
    ...
    /**
     * Sets the scene to the PartsView and calls a method in the {@link io.github.wander.inventorymanager.PartController} that sets the parts view to add parts mode
     *
